...
import { Heart, Mail, Lock, Eye, EyeOff, ArrowLeft, Check } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      await createUserDocument(user.uid, user.email || "");
      toast.success("Welcome to DatingHub! 🎉");
      router.push("/profile/setup");
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      <Link
        href="/home"
        className="absolute top-5 left-5 z-20 flex items-center gap-1.5 text-white/80 hover:text-white transition text-sm font-medium"
      >
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10">
          ...
          <div className="text-center mb-7">
            <div className="inline-flex w-14 h-14 rounded-2xl bg-linear-to-br from-pink-500 to-purple-600 items-center justify-center shadow-lg mb-4">
              <Heart size={26} className="text-white fill-white" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900">Create Account</h1>
            <p className="text-gray-400 text-sm mt-1">Join thousands finding love on DatingHub</p>
          </div>
          ...
          <p className="text-xs text-gray-400 text-center mt-4">
            ...
            <a href="#" className="underline hover:text-pink-500">Terms</a> and{" "}
            <a href="#" className="underline hover:text-pink-500">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
