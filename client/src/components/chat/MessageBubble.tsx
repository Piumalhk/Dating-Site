...
export default function MessageBubble({ message, isOwn }: MessageBubbleProps) {
    ...
    return (
      <div className="flex justify-end mb-1.5 group">
        <div className="max-w-[72%] sm:max-w-[60%]">
          <div className="bg-linear-to-r from-pink-500 to-purple-600 text-white rounded-2xl rounded-br-sm px-4 py-2.5 shadow-sm">
          ...
          <div className="flex items-center justify-end gap-1 mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {/* ✓ sent  ✓✓ read */}
            <span
              className={`text-[11px] ${message.read ? "text-purple-500" : "text-gray-400"}`}
  ...
  return (
    <div className="flex justify-start mb-1.5 group">
      <div className="max-w-[72%] sm:max-w-[60%]">
